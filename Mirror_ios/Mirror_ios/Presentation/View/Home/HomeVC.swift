...
class HomeVC: BaseController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        TTS.shared.stop()
        TTS.shared.play("이미지 묘사, 물건 찾기, 문서 읽기 총 3가지의 기능을 제공합니다. 각 기능은 어플 하단 네비게이션 바를 통해 홈 / 물건 찾기 / 이미지 설명 / 문서 읽기 순으로 사용하실 수 있습니다. 왼쪽 오른쪽으로 슬라이드 하거나 하단 네비게이션 바를 클릭하여 해당 기능으로 이동 가능합니다.")
    }
